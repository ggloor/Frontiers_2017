...
f.pos <- as.numeric(which(cor.rare.p["11",] > 0.75 & rho.rare@matrix["11",] < 0.25))

plot(cor.rare.p["11",],rho.rare@matrix["11",], pch=19, col=rgb(0,0,0,0.3), xlab="Pearson cor", ylab="E(rho)", main="r vs E(rho)")
points(cor.rare.p["11",f.pos],rho.rare@matrix["11",f.pos], pch=19, col="red")
